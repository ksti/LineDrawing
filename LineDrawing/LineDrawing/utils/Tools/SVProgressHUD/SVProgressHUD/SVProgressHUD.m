...
//        } else {
            ...
            SVProgressHUDBackgroundColor = [UIColor colorWithWhite:0.0f alpha:0.6f];
...
//
//自己新增
+ (void)showAlterMessage:(NSString*)string{
    [self sharedView];
    [self showImage:nil status:string maskType:SVProgressHUDDefaultMaskType];
}
