...
#define WINDOWWIDTH [UIApplication sharedApplication].keyWindow.frame.size.width
...
- (void)showInVC:(UIViewController *)vcParent
{
//    UIWindow *window = [UIApplication sharedApplication].keyWindow;
//    [window addSubview:self.view];
//    [window.rootViewController addChildViewController:self];
    [vcParent addChildViewController:self];
    [vcParent.view addSubview:self.view];
...
{
    if ([self.delegate respondsToSelector:@selector(photoBrowser:photoViewDidEndZoom:)]) {
        [self.delegate photoBrowser:self photoViewDidEndZoom:photoView];
    }
...
//{
//    
//    QLLog(@"Recieve memory warning");
//    QLLog(@"~~~~~~~~~~~~~~level~~~~~~~~~~~~~~~ %d", (int)OSMemoryNotificationCurrentLevel());
//}
