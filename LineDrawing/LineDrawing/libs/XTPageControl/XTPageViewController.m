...
- (void)viewDidLayoutSubviews {
    ...
    self.pageScrollView.frame = CGRectMake(0, [self.topLayoutGuide length] + self.tabBarHeight + 1.0, self.view.bounds.size.width, self.view.bounds.size.height - self.tabBarHeight - 1.0 - [self.topLayoutGuide length] - [self.bottomLayoutGuide length]);
...
- (void)showNextController:(NSInteger)nextPage {
    ...
    if (nextController == nil) {
        nextController = [self.dataSource controllerOfPage:nextPage];
