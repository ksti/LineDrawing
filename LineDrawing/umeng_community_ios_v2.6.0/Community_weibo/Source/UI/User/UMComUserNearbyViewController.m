...
- (void)showNoLocationAuthTip
{
    if (!_noLocationTip) {
        ...
        [tip setTextColor:UMComColorWithColorValueString(@"#A5A5A5")];
     ...
     didUpdateLocations:(NSArray *)locations
{
    ...
    self.fetchRequest = [[UMComUserNearbyRequest alloc] initWithLocation:manager.location count:BatchSize];
