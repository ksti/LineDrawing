...
- (void)viewDidLoad {
    ...
    [self setForumUITitle:UMComLocalizedString(@"um_com_message", @"消息")];
    
    self.titles = [NSArray arrayWithObjects:
                   UMComLocalizedString(@"um_com_comment", @"评论"),
                   UMComLocalizedString(@"um_com_favour",@"赞"),
                   UMComLocalizedString(@"um_com_@me", @"@我"),
                   UMComLocalizedString(@"um_com_notification", @"通知"),
                   UMComLocalizedString(@"um_com_managerPrivateMessage", @"管理员私信"), nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        ...
        case 2:
        {
            ...
            [hotPostListController setTitleViewWithTitle:UMComLocalizedString(@"um_com_@me", @"@我")];
