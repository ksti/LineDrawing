...
extern  NSInteger  const  ERR_CODE_ACCESS_TOKEN_EXPIRED;
extern  NSInteger  const  ERR_CODE_DECRYPT_DATA_INCORREC;
extern  NSInteger  const  ERR_CODE_ENCRYPTED_DATA_IS_INCOMPLETE;
extern  NSInteger  const  ERR_CODE_REQUEST_MISS_THE_ACCESS_TOKEN;
extern  NSInteger  const  ERR_CODE_USER_IDENTITY_IS_INVAILD;
