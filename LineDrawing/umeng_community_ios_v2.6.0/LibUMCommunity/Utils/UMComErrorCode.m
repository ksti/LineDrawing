...
NSInteger  const  ERR_CODE_ACCESS_TOKEN_EXPIRED = 50005;
NSInteger  const  ERR_CODE_DECRYPT_DATA_INCORREC = 50007;
NSInteger  const  ERR_CODE_ENCRYPTED_DATA_IS_INCOMPLETE = 50008;
NSInteger  const  ERR_CODE_REQUEST_MISS_THE_ACCESS_TOKEN = 50009;
NSInteger  const  ERR_CODE_USER_IDENTITY_IS_INVAILD = 10005;
