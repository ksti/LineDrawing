...
#define LoginCustomAccountPath @"user/login/self_account"
...
#define UserLocationPath @"user/located"

#define UserNearbyPath @"user/nearby"
...
//2.5新增
#define CommunityGuest        @"user/guest"  //获得社区的访客模式
#define CommunityToken        @"user/token"  //获取令牌

//新增积分接口(since 2.5)
#define CommunityPointDetail    @"pointbank/point/details/" //查看用户积分明细
#define CommunityPointOperation @"pointbank/point/op/" //积分增减的接口

#define CommunityCurrencyDetail @"pointbank/currency/details/" //查看用户货币明细
#endif
